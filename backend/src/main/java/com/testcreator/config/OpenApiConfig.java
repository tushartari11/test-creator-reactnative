 ...
 *
 * <p>Configures SpringDoc OpenAPI to generate comprehensive API documentation with proper security
 * schemes for JWT authentication and detailed server information.
 *
...
@SecurityScheme(
    ...
    bearerFormat = "JWT",
    description =
        "JWT token authentication. Include the JWT token in the Authorization header using the"
            + " Bearer scheme.")
...
public class OpenApiConfig {
  ...
  @Value(
      "${app.description:Online examination platform with advanced proctoring and test management"
          + " capabilities}")
