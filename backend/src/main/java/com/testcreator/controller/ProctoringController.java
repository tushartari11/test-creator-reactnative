 ...
 *
 * <p>
 * Allows teachers to view proctoring violations and analytics
 * for their tests and student attempts.
 */
@RestController
...
public class ProctoringController {
    ...
    @Operation(summary = "Get violations for attempt", description = "Retrieves all proctoring violations recorded for a specific test attempt")
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Violations retrieved", content = @Content(schema = @Schema(implementation = ViolationDTO.class))),
    ...
    @Operation(summary = "Get violation summary for attempt", description = "Retrieves a summary of violations with counts by type and severity")
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Summary retrieved", content = @Content(schema = @Schema(implementation = ViolationSummaryDTO.class))),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
            @ApiResponse(responseCode = "403", description = "Not your test"),
            @ApiResponse(responseCode = "404", description = "Attempt not found")
    })
    ...
    @Operation(summary = "Get violations for all attempts of a test", description = "Retrieves violation summaries for all students who attempted the test")
    @ApiResponses({
