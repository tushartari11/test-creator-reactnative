 ...
 *
 * <p>Handles test browsing, taking tests, and viewing results. Restricted to students.
 */
@RestController
...
public class StudentTestController {
  ...
  @Operation(
      ...
      description = "Retrieves list of published tests available for the student to attempt")
  @ApiResponses({
  ...
  @Operation(
      ...
      description = "Starts a new test attempt, initializing a test session with time limit")
  @ApiResponses({
  ...
  @Operation(
      ...
      description = "Retrieves current progress of an ongoing test attempt")
  @ApiResponses({
  ...
  @Operation(
      ...
      description = "Submits answer for a single question. Auto-saves to server.")
  @ApiResponses({
  ...
  public ResponseEntity<Void> submitAnswer(
    ...
    log.info(
        "Submit answer request - attemptId: {}, questionId: {}, option: {}",
        attemptId,
  ...
  @Operation(
      summary = "Submit test for grading",
      description = "Submits entire test for auto-grading and score calculation. Ends the session.")
  @ApiResponses({
  ...
  @Operation(
      ...
      description = "Retrieves summary of all test results for the student")
  @ApiResponses({
  ...
  @Operation(
      ...
      description = "Retrieves detailed result showing all questions, answers, and explanations")
  @ApiResponses({
  ...
  @Operation(
      summary = "Auto-save answer (fast)",
      description = "Caches answer to Redis for quick auto-save. Background job syncs to database.")
  @ApiResponses({
  ...
  public ResponseEntity<Void> autoSaveAnswer(
    ...
    log.debug(
        "Auto-save answer - attemptId: {}, questionId: {}", attemptId, request.getQuestionId());
  ...
  @Operation(
      summary = "Recover cached answers",
      description = "Retrieves answers from Redis cache for session recovery after disconnect")
  @ApiResponses({
  ...
  @Operation(
      ...
      description = "Updates session activity timestamp for monitoring and recovery")
  @ApiResponses({
  ...
  @Operation(
      ...
      description =
          "Records a proctoring violation detected by the frontend (tab switch, copy attempt,"
              + " etc.)")
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
