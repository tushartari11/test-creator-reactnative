 ...
 *
 * <p>Handles CRUD operations for tests. Restricted to teachers.
 */
@RestController
...
@Tag(
    ...
    description = "Test creation, management, and publishing (Teacher only)")
...
public class TestController {
  ...
  @Operation(
      ...
      description = "Parses a CSV file and returns questions/options for review before saving.")
  @ApiResponses({
  ...
  @Operation(
      ...
      description = "Creates a new test with questions and options. Only accessible to teachers.")
  @ApiResponses({
    @ApiResponse(
        responseCode = "201",
  ...
  @Operation(
      ...
      description =
          "Retrieves all tests created by the authenticated teacher with pagination and filtering")
  @ApiResponses({
  ...
  public ResponseEntity<Page<TestListDto>> getAllTests(
      ...
      @Parameter(description = "Filter by status (DRAFT, PUBLISHED, ARCHIVED)")
          ...
          String status,
      @Parameter(description = "Sort field (title, testDate, createdAt)")
  ...
  @Operation(
      ...
      description =
          "Retrieves detailed information about a test including all questions and options")
  @ApiResponses({
  ...
  @Operation(
      ...
      description = "Updates an existing test. Can only update tests in DRAFT status.")
  @ApiResponses({
    @ApiResponse(responseCode = "200", description = "Test updated successfully"),
    @ApiResponse(
        responseCode = "400",
        description = "Validation error or test not in DRAFT status"),
    @ApiResponse(responseCode = "401", description = "Unauthorized"),
  ...
  @Operation(
      ...
      description =
          "Publishes a test making it available for students to attempt. Can only publish DRAFT"
              + " tests.")
  @ApiResponses({
  ...
  @Operation(
      ...
      description = "Archives a test removing it from active use but keeping records.")
  @ApiResponses({
  ...
  @Operation(
      ...
      description = "Generates a guest access code for the test (format: guest_XXXXXX)")
  @ApiResponses({
  ...
  @Operation(
      ...
      description = "Deletes a test. Can only delete tests with no student attempts.")
  @ApiResponses({
  ...
  @Operation(
      summary = "Reset student attempt",
      description =
          "Deletes a student's attempt for a test so they can retake it. Only the teacher who owns"
