...
/**
 * DTO containing analytics for a single question.
 * Shows how students performed on each question.
 */
@Data
@Builder
@NoArgsConstructor
...
public class QuestionAnalyticsDTO {
  ...
  @Schema(description = "Distribution of answers by option number", example = "{\"1\": 10, \"2\": 35, \"3\": 5}")
