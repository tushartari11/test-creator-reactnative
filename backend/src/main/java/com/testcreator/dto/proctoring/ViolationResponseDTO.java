...
/**
 * Response DTO when a violation is reported.
 * Contains action instructions for the frontend.
 */
@Data
@Builder
@NoArgsConstructor
...
public class ViolationResponseDTO {
    ...
    @Schema(description = "Warning message to display to student", example = "Tab switching detected. Please stay on the test page.")
    ...
    @Schema(description = "Whether test should be auto-submitted due to violations", example = "false")
    private Boolean forceSubmit;

    @Schema(description = "Reason for force submit (if applicable)", example = "Too many critical violations")
     ...
     */
    public static ViolationResponseDTO warning(String message, long totalViolations, int remainingAttempts) {
        return ViolationResponseDTO.builder()
                .recorded(true)
                .showWarning(true)
     ...
     */
    public static ViolationResponseDTO forceSubmit(String reason, long totalViolations, long criticalViolations) {
        return ViolationResponseDTO.builder()
                .recorded(true)
                .showWarning(true)
