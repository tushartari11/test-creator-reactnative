 ...
 *
 * <p>Contains guest session token to access test without authentication.
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
...
public class GuestTestAccessDto {
  ...
  @Schema(
      ...
      example = "guest_123e4567-e89b-12d3-a456-426614174000")
  ...
  @Schema(
      ...
      example = "http://app.com/guest-test/guest_123e4567-e89b-12d3-a456-426614174000")
