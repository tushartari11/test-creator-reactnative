 ...
 *
 * <p>
 * Records security violations detected by the frontend proctoring system,
 * such as tab switches, copy attempts, and window blur events.
 *
 * @see TestAttempt
 * @see ViolationType
...
public class ProctoringViolation {
    ...
    /**
     * Additional details about the violation stored as JSON.
     * Can include browser info, screen dimensions, keyboard keys, etc.
     */
    ...
    /**
     * Timestamp from the client when the violation occurred.
     * May differ from createdAt due to network delay.
     */
    ...
    public static ViolationSeverity getDefaultSeverity(ViolationType type) {
        return switch (type) {
            ...
            case COPY_PASTE, KEYBOARD_SHORTCUT, HEARTBEAT_MISSED, CONNECTION_LOST -> ViolationSeverity.HIGH;
