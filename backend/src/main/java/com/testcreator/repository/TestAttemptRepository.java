 ...
 *
 * <p>Handles test-taking sessions and proctoring data.
 *
 * @see TestAttempt
 */
@Repository
public interface TestAttemptRepository extends JpaRepository<TestAttempt, Long> {
   ...
   */
  @Query(
      "SELECT ta FROM TestAttempt ta " + "LEFT JOIN FETCH ta.answers " + "WHERE ta.id = :attemptId")
  ...
  Optional<TestAttempt> findByIdAndStudentEmail(
      @Param("attemptId") Long attemptId, @Param("studentEmail") String studentEmail);
   ...
   */
  @Query(
      "SELECT AVG(ta.score) FROM TestAttempt ta "
  ...
  Optional<TestAttempt> findFirstByTestIdAndStudentIdAndStatus(
  ...
  Optional<TestAttempt> findLatestAttemptByTestAndStudent(
      @Param("testId") Long testId, @Param("studentId") Long studentId);
