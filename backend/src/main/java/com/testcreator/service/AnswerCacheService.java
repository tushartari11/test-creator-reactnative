 ...
 *
 * <p>
 * Provides fast read/write operations for auto-save functionality.
 * Answers are cached during test taking and periodically synced to database.
 */
@Service
...
public class AnswerCacheService {
    ...
    public void cacheAnswer(Long attemptId, Long questionId, Integer selectedOption) {
        ...
        CachedAnswerDTO cachedAnswer = CachedAnswerDTO.builder()
                .attemptId(attemptId)
        ...
        log.debug("Cached answer for attempt: {}, question: {}, option: {}",
