 ...
 *
 * <p>Lives only in the test-support module — never touches production code.
 * Used by {@link TestSupportService} to delete exactly the rows a scenario
 * created, so cleanup is precise and parallel-safe.
 */
@Component
@Profile("e2e")
