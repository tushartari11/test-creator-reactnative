...
/**
 * Test-support REST surface. Profile-guarded — never registered outside the
 * {@code e2e} profile. Endpoints:
 *
 * <pre>
...
public class TestSupportController {
    ...
    public LoginAsResponse loginAs(
        @PathVariable("id") UUID scenarioId,
        @RequestBody LoginAsRequest req
    ) {
    ...
    public ResponseEntity<Map<String, String>> handleNotFound(ScenarioLedger.ScenarioNotFoundException ex) {
